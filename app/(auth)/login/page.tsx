...
export default function LoginPage() {
  ...
  return (
    <div style={{width:"100%", maxWidth:"420px", background:"hsl(224 71% 6%)", border:"1px solid hsl(216 34% 17%)", borderRadius:"16px", padding:"40px"}}>
          ...
          <div style={{background:"rgba(239,68,68,0.1)", border:"1px solid rgba(239,68,68,0.3)", borderRadius:"8px", padding:"10px 14px", fontSize:"13px", color:"#f87171", marginBottom:"16px"}}>
            ...
            {error.includes("Invalid") && (
              <div style={{marginTop:"6px", fontSize:"12px"}}>
                Did you sign up on this site? <a href="/signup" style={{color:"#a78bfa"}}>Create an account</a>
              </div>
            )}
          </div>
        )}
      ...
      <div style={{marginTop:"16px", padding:"12px", background:"rgba(124,110,245,0.08)", borderRadius:"8px", fontSize:"12px", color:"hsl(215 20% 65%)"}}>
        <strong style={{color:"#a78bfa"}}>Note:</strong> This is the live site. If you signed up on localhost, you need to create a new account here.
      </div>
